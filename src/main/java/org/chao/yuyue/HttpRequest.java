...
public class HttpRequest {
    ...
    // "SESSION_COOKIE=11ab1829cea36edbcez07f7e; Hm_lvt_bc7eaca5ef5a22b54dd6ca44a23988fa=1555300632;
    // JSESSIONID=317D8220B81776D628A1D164E1F986C1; Hm_lpvt_bc7eaca5ef5a22b54dd6ca44a23988fa=1555310546"
    ...
    public static boolean login(String url, String username, String password) {
        ...
        try {
            ...
            String param = String.format("mobileNo=%s&password=%s&isAjax=true", usernameBase64, passwordBase64);
            out.print(param);
            // flush输出流的缓冲
            out.flush();
            // 定义BufferedReader输入流来读取URL的响应
            ...
            if ("200".equals(code)) {
                ...
                for (Iterator iterator = set.iterator(); iterator.hasNext();) {
                    ...
                    if ("Set-Cookie".equals(key)) {
                        ...
                        firstCookie = builder.toString().substring(0,builder.toString().length()-2);
                        System.out.println("得到的cookie=" + firstCookie);
	                    cookie = firstCookie;
	                    return true;
                    }
                }
